...
# Cut CUDA allocator fragmentation so the same TTS+avatar workload fits in less reserved
# VRAM on the shared 16GB card (no behavior change; pure allocator hint).
