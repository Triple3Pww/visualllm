...
PROMPT_WAV = str(COSY_DIR / "asset" / "zero_shot_prompt.wav")
...
class TTSEngine:
    def __init__(self, model_dir: str | None = None, fp16: bool = False):
        import torch
        ...
        self.model = CosyVoice2(self.model_dir, load_jit=False, load_trt=False, fp16=fp16)
